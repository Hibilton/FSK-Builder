...
# Data files
CSV_STOCKED = "fsk_build_options_generated_v6_stocked_only_rich.csv"
CSV_STOCKED_OR_ORDERABLE = "fsk_build_options_generated_v5_stocked_or_orderable.csv"
...
def main():
    ...
    # Use current mode to populate shaft/stern lists
    ...
    # Toggle placed beneath shaft/stern
